...
RobotomyRequestForm::RobotomyRequestForm() : Form("untitle_file", 72, 45), _target("untitled_target")
{
	return;
}
...
RobotomyRequestForm::RobotomyRequestForm(std::string target) : Form("untitle_file", 72, 45), _target(target)
{
	return;
}

RobotomyRequestForm::RobotomyRequestForm(std::string target, std::string name) : Form(name, 72, 45), _target(target)
{
	return;
}
